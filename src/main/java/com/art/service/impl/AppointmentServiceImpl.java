...
//    int insert = 0;
//    if (num >= 1) {
//      insert = appointmentDao.insert(record);
...
////    List<Appointment> appointments = appointmentDao.selectByExample(example);
//
...
//        i = appointmentDao.updateByPrimaryKey(appointment);
